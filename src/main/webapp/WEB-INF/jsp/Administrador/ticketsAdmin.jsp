    ...
    <body>
        ...
        <main class="contenido">
                ...
                <form class="filtros-form" method="get" action="${pageContext.request.contextPath}/tickets">
                    ...
                    <div class="campo-filtro">
                        ...
                        <div class="input-busqueda">
                            <span>⌕</span>
                            <input type="text" name="buscar" value="${filtroBuscar}" placeholder="Título, descripción o ID...">
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <c:forEach var="ticket" items="${tickets}">
                                <tr>
                                    ...
                                    <!-- CATEGORÍA -->
                                    <td>
                                        <span class="categoria-texto">${ticket.nombreCategoria}</span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="persona">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <span class="sin-agente">Sin asignar</span>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </td>
            ...
            <div class="paginacion">
                <span class="paginacion-info">Mostrando ${totalTickets} tickets</span>
                <div class="paginas">
        ...
        <script>
            ...
            function mostrarAsignacion(idTicket, boton) {
                ...
                // Posición horizontal
                let izquierda = rect.right - anchoMenu;
            ...
            function cambiarTipoAsignacion(idTicket) {

                const tipo =
                        document.getElementById(
                                "tipoAsignacion-" + idTicket
                                );
                ...
                if (tipo.value === "automatico") {

                    // No necesitamos seleccionar agente
